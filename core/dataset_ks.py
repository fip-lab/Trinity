...
__all__ = ['KSDataset', 'KSDataLoader']
...
class KSDataset(Dataset):
    def __init__(self, args, mode='train'):
        ...
        data = data[mode]
        self.ids = np.array(data['youtube_id'])
...
def KSDataLoader(args, mode='train'):
    if mode == 'train':
        datasets = {
            'train': KSDataset(args, 'train'),
            # 'valid': KSDataset(args, 'valid'),
            'test': KSDataset(args, 'test')
        }
    else:
        datasets = {
            'test': KSDataset(args, 'test')
